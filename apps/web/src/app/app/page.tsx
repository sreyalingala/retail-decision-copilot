...
import { listAnalyses, runAnalysis } from "@/lib/analyticsApi";
        ...
        <div className="flex flex-col gap-8">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <Badge variant="outline">No AI yet</Badge>
            </div>
            <h1 className="text-3xl font-semibold tracking-tight">Analyst workspace</h1>
            <p className="text-sm text-muted-foreground">
              Choose an analyst-grade SQL analysis, optionally adjust parameters, and run to get:
              SQL, results, and execution metadata.
            </p>
          </div>
                ...
                <CardContent className="space-y-5">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="text-xs text-muted-foreground">
                      AI-powered natural language querying will be added next.
                    </div>
